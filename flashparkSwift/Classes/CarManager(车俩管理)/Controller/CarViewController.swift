...
class CarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = navigationTitleAttribute as? [String : AnyObject]
         ...
         self.navigationItem.leftBarButtonItem=UIBarButtonItem(image: UIImage.init(named: "back-w")?.imageWithRenderingMode(.AlwaysOriginal),style: UIBarButtonItemStyle.Plain, target: self, action: #selector(CarViewController.doneSlide) )
